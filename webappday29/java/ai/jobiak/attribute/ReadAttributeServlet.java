...
@WebServlet(description = "to read the attributes", urlPatterns = { "/readattributes" })
public class ReadAttributeServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("JDK VERSION"+context.getAttribute("jdk"));
		out.println("Platform"+context.getAttribute("os"));
